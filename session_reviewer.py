...
from prompts.session_review import (
    SYSTEM_PROMPT as REVIEW_SYSTEM_PROMPT,
    USER_PROMPT as REVIEW_USER_PROMPT,
)

logger = logging.getLogger(__name__)


# Legacy aliases removed — prompts now live in prompts/session_review.py
# REVIEW_SYSTEM_PROMPT and REVIEW_USER_PROMPT are imported above.
